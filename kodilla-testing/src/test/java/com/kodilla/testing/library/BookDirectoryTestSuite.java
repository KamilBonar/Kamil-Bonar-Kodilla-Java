...
class BookDirectoryTestSuite {
    ...
    void testListZeroBooksInHandsOf() {
        ...
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "11111111111");
        List<Book> rentZeroBooks = new ArrayList<Book>();
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(rentZeroBooks);
    ...
    void testListOneBookInHandsOf() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "11111111111");
        List<Book> rentOneBook = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(rentOneBook);
    ...
    void testListFiveBooksInHandsOf() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "11111111111");
        List<Book> rentFiveBooks = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(rentFiveBooks);
